...
from CGNet_Model_MyDecoder import *
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Codes Testing things//test_13-3-2025__ChangeFormer+CGNet - 2//checkpoints//checkpoint4-BCE-100epochs//ResUnet99.pth"))
    model.eval()
    test_results_path="E://VS Codes Testing things//test_13-3-2025__ChangeFormer+CGNet - 2//test results//test_results4-BCE-100epochs"
